...
Step-2:Encoding categorical data, which implies converting categorical data into integer format so that the data with converted categorical values can be provided to the models to give and improve the predictions.<br>
...
Step-3:Splitting the data set into test set and training set using train_test_split from sci-kit learn.<br>
...
Step-4:After specifying the test set and training set, building of ANN model was done as per the following steps:
<img width="878" alt="4" src="https://user-images.githubusercontent.com/88343647/224536326-e4c95265-32be-47d0-a5d7-508b8416cfdc.png">
...
<b>Accuracy of the model was 0.8615<b><br>
    ...
    No. of people predicted correctly (not stay): 203<br>
    <img width="882" alt="5" src="https://user-images.githubusercontent.com/88343647/224536594-6df2f638-2fca-451c-bd23-190fc1739efb.png">
